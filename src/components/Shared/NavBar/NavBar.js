...
Restaurant Patio design */}
                  ...
                  <li>
                    <p className="dropdown-item"onClick={()=>history.push('/services/patio-heating')}
                  ...
                  <li>
                    ...
                    > */}
                    <p className="dropdown-item"onClick={()=>history.push('/services/motorized-shades')}
                  ...
                  <li>
                    {/* <a className="dropdown-item" href="/services/outdoor-lighting"
                      >OUTDOOR LIGHTING</a
                    > */}
                    <p className="dropdown-item"onClick={()=>history.push('/services/outdoor-lighting')}
                    style={{cursor:'pointer', marginTop:'-10px'}}
                      >OUTDOOR LIGHTING</p
                    >
                  </li>
                  <li>
                    {/* <a className="dropdown-item" href="/services/audio-and-video"
                      >AUDIO AND VIDEO</a
                    > */}
                    <p className="dropdown-item"onClick={()=>history.push('/services/audio-and-video')}
                    style={{cursor:'pointer', marginTop:'-10px'}}
                      >AUDIO AND VIDEO</p
                    >
                  </li>
                  <li>
                    {/* <a className="dropdown-item" href="/services/outdoor-furniture"
                      >OUTDOOR FURNITURE</a
                    > */}
                    <p className="dropdown-item"onClick={()=>history.push('/services/outdoor-furniture')}
                    style={{cursor:'pointer', marginTop:'-10px'}}
                      >OUTDOOR FURNITURE</p
                    >
                  </li>
                  <li>
                    ...
                    > */}
                    <p className="dropdown-item"onClick={()=>history.push('/services/restaurant-patio-design')}
                    style={{cursor:'pointer', marginTop:'-10px'}}
                      >RESTAURANT PATIO DESIGN</p
                    >
                  </li>
              ...
              {(props.showLoginLogout && props.isLoggedIn ) && (
                <li className="nav-item" onClick={()=>{sessionStorage.clear(); window.location.reload();}}>
